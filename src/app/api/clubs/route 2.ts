...
import { SYNTHETIC_CLUBS } from '@/lib/syntheticData';
...
export async function GET() {
  try {
    ...
    console.error('[api/clubs] DB failed, serving synthetic fallback:', e);
    const res = NextResponse.json(SYNTHETIC_CLUBS);
